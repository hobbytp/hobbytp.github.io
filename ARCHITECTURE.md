...
- ✅ Added left sidebar navigation with profile, menu, articles, and projects sections
- ✅ Implemented two-column article card layout for list pages
- ✅ Updated CSS limit from 500 to 1000 lines to accommodate new layout features
- ✅ All list pages (home, categories, tags) now use consistent sidebar layout
...
- `assets/css/custom.css` - ✅ **615 lines** (within 1000-line limit)
...
- ❌ `assets/css/custom.css` > 1000 lines (currently 615 lines ✅)
...
- `layouts/_default/baseof-spa.html` - 🔄 **PRESERVED FOR REFERENCE**
- `layouts/_default/list-spa.html` - 🔄 **PRESERVED FOR REFERENCE**
- `layouts/_default/single-spa.html` - 🔄 **PRESERVED FOR REFERENCE**
...
- ✅ Use Hugo v0.146.0+ with PaperMod theme
- ✅ Follow standard Hugo template hierarchy
- ✅ Use CSS custom properties for theming
- ✅ Test with `make build` before committing
- ✅ Keep `assets/css/custom.css` under 1000 lines (currently 615 lines)
...
- ✅ External CSS CDN dependencies (none allowed)
- ✅ Hugo build success
...
- **Fixes Applied:** `docs/architecture-fixes.md`
