...
# No new branch for committing blog 
...
This project is indexed by GitNexus as **hobbytp.github.io** (15120 symbols, 16104 relationships, 68 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/hobbytp.github.io/context` | Codebase overview, check index freshness |
| `gitnexus://repo/hobbytp.github.io/clusters` | All functional areas |
| `gitnexus://repo/hobbytp.github.io/processes` | All execution flows |
| `gitnexus://repo/hobbytp.github.io/process/{name}` | Step-by-step execution trace |
