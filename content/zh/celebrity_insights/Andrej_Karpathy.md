...
updated: "2025-10-22T22:30:00+08:00"
draft: false
...
## 一、Andrej Karpathy: 软件正在改变 (Again)
...
## 二、Dwarkesh Patel的深度访谈（2025年10月）
Andrej Karpathy 在2025年10月接受Dwarkesh Patel的[深度访谈](https://www.youtube.com/watch?v=lXUZvyajciY)中，系统阐述了他对AI现状与未来的核心看法，其观点冷静且颇具批判性，在业内引起了广泛讨论。

下面的表格梳理了本次访谈涉及的主要话题，方便快速了解其核心观点。

| 话题领域 | Karpathy 的核心观点摘要 |
| :--- | :--- |
| **AGI（通用人工智能）发展时间线** | 认为达到真正的AGI仍需约**10年**，当前是“智能体的十年”而非“智能体之年”；AGI的影响将是**渐进式**的，不会导致经济“大爆炸”。 |
| **AI智能体（Agent）现状** | 当前智能体（如Claude、Codex）存在**四大认知缺陷**：智能水平不足、多模态能力弱、无法熟练使用计算机、缺乏持续学习能力，尚不能作为可靠的“数字员工”。 |
| **技术路径批判** | 批评强化学习（RL）效率低下，如同“**通过吸管汲取监督信号**”；指出大模型存在“**模型坍塌**”风险，即用自身生成的数据训练会导致多样性枯竭。 |
| **模型架构的未来** | 提出“**认知核心**”概念，认为未来AI发展方向不是追求更大参数，而是剥离冗余记忆，保留核心算法能力，甚至**10亿参数**的模型就可能具备强大智能。 |
| **对人类学习的借鉴** | 对比人类学习，指出AI缺乏**反思、遗忘和做梦**等关键机制，而这些可能是防止“模型坍塌”、提升泛化能力的关键。 |
| **对行业与教育的看法** | AI是计算的**自然延伸**，而非颠覆性革命；其教育项目Eureka Labs旨在构建“知识坡道”，帮助人们在AI时代提升认知能力。 |

### 💡 核心观点详解

为了能更深入地理解他的思想，以下是对几个关键观点的进一步阐述：

- **“智能体十年”的判断依据**：Karpathy认为，从“演示级”的智能体到“产品级”的智能体，需要突破多个“九”的可靠性门槛（例如从90%到99%，再到99.9%），每一步（每增加一个9）的推进都需要巨大的努力，这决定了其发展不会一蹴而就。

- **“幽灵”与“动物”的深刻比喻**：他认为我们当前构建的AI（“幽灵”）是通过模仿互联网数据产生的“精神实体”，与经过数十亿年演化、拥有先天硬件和本能的生物智能（“动物”）有本质区别。这一比喻强调了我们并未复制演化过程，而是找到了一条不同的工程路径。

- **对强化学习（RL）的批评**：他用“通过吸管汲取监督信号”形象地指出RL的低效。RL只根据最终结果的单一信号来调整整个行为过程，无法进行精细的“复盘”，这与人类的学习方式相去甚远。

- **“认知核心”与模型规模**：在业界追逐更大模型的背景下，Karpathy反其道而行之，认为智能的关键不在于记忆多少知识，而在于核心的推理和算法能力。他预测，未来一个精炼的、参数更少的“认知核心”可能更加强大，这类似于人类专家善于思考而非死记硬背。

### 参考
* [Dwarkesh Patel的深度访谈](https://www.youtube.com/watch?v=lXUZvyajciY)
* [My NotebookLM Link](https://notebooklm.google.com/notebook/ffd7feca-7615-4ddd-b33f-29f6b8b68fff)
